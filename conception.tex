...
\begin{titlepage}
  ...
  \vspace{17em}{\centering\large{Agnieszka Dudek, Piotr Kowalczyk}\par}
	...
	\vspace{17em}{\centering\large{Wrocław, 2018-12-05}\par}
...
Po zalogowaniu do Systemu Zapisów widoczny jest przycisk podpisany Tablica efektów (dalej zwany przyciskiem). 
